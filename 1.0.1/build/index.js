 ...
 * @module xscroll
 **/
KISSY.add('kg/xscroll/1.1.0/index',function(S, Node, Event, Base, Pan, Pinch, Util) {
    var $ = S.all;
    var clsPrefix,
        containerClsName,
        contentClsName;
    ...
    var XScroll = Base.extend({
        ...
        _createContainer: function() {
            ...
            var container = $("." + containerClsName, self.$renderTo)[0];
            var content = $("." + contentClsName, self.$renderTo)[0];
            self.$ctn = $(container);
        ...
        */
        ...
        stop:function(){
            ...
            if(Util.isAndroid){
                this.$content[0].style[transitionDuration] = "0.001s";
                this.$ctn[0].style[transitionDuration] = "0.001s";
            }else{
                this.$content[0].style[transition] = "none";
                this.$ctn[0].style[transition] = "none";
            }
        },
        _transform:function(){
