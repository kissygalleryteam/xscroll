...
kg/xscroll/1.1.9/plugin/scrollbar
 ...
 **/
;
KISSY.add('kg/xscroll/1.1.9/plugin/scrollbar',function(S, Node, Base, Anim,Util) {
	var $ = S.all;
	//最短滚动条高度
	...
	requires: ['node', 'base', 'anim','kg/xscroll/1.1.9/util']
})
